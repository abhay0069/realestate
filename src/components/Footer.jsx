                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-12 mb-40">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 font-sans text-sm text-white/80">
                            <li><Link to="/travel" className="hover:text-white cursor-pointer transition-colors">Buying</Link></li>
                            <li><Link to="/contact" className="hover:text-white cursor-pointer transition-colors">Selling</Link></li>
                            <li><Link to="/villas" className="hover:text-white cursor-pointer transition-colors">Concierge</Link></li>
                            <li><Link to="/experiences" className="hover:text-white cursor-pointer transition-colors">Relocation</Link></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 font-sans text-sm text-white/80">
                            <li className="hover:text-white cursor-pointer">Contact Agents</li>
                    ...
                    {/* PAY SAFELY */}
                    <div>
                        <h4 className="font-sans font-bold text-[10px] tracking-[0.2em] text-white/40 mb-8 uppercase">Memberships</h4>
                        <div className="flex gap-2">
                            <div className="text-white/60 text-xs">NAR Member</div>
                            <div className="text-white/60 text-xs">Luxury Portfolio</div>
                        </div>
                    </div>
                </div>
